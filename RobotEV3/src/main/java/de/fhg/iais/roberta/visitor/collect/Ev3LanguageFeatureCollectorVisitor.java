...
public class Ev3LanguageFeatureCollectorVisitor extends AbstractLanguageFeatureCollectorVisitor implements IEv3Visitor<Void> {

    public Ev3LanguageFeatureCollectorVisitor(LanguageFeatureBean.Builder builder) {
        super(builder);
    }
